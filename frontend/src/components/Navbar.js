...
import photo from '../components/Images/hamburguer-svgrepo-com.svg'
    ...
    return (
        <div>
            <nav className="navbar navbar-expand-lg navbar-dark bg-success position-sticky"
                ...
                <img _ngcontent-serverapp-c50="" src={photo} alt="Start Bootstrap Logo" style={{width:"80px", height:"80px"}}/>
                    <Link className="navbar-brand fs-1 fst-italic" to="/">FOODOPHILE</Link>
